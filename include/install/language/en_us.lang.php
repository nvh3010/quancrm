...
$installationStrings = array(
	'LBL_VTIGER_CRM_5' => 'Quân CRM',
	'LBL_CONFIG_WIZARD' => 'Configuration Wizard',
	'LBL_WELCOME' => 'Welcome',
	'LBL_WELCOME_CONFIG_WIZARD' => 'Welcome to Configuration Wizard',
	'LBL_ABOUT_CONFIG_WIZARD' => 'Đây là trình hỗ trợ cấu hình giúp bạn cài đặt Quân CRM ',
	'LBL_ABOUT_VTIGER' => 'Quân CRM là phần mềm được phát triển dựa trên mã nguồn mở của vtiger CRM <br><br>
							Mục đích là cung cấp một phần mềm chuyên nghiệp và đầy đủ các tính năng cần thiết cho việc quản trị quan hệ khách hàng tại công ty Elcom<br><br> 
							 <br><br>
							Phần mềm đã được thiết kế lại bởi Võ Trần Quân - Sinh viên Khoa Tin Học Kinh Tế,Trường Đại Học Kinh Tế Quốc Dân!<br> <br>
							.',
	'LBL_INSTALL' => 'Cài đặt',
	'LBL_MIGRATE' => 'Thoát',
	...
	'LBL_SUCCESSFULLY_INSTALLED' => 'Cài đặt thành công',
	...
	'LBL_TALK_TO_US_AT_FORUMS' => 'Hãy ghé thăm <a href="http://quansolid@blogspot.com" target="_blank">Blog của tôi</a>',
	'LBL_DISCUSS_WITH_US_AT_BLOGS' => 'Thảo luận với tôi <a href="https://www.facebook.com/qz.vo1" target="_blank">Facebook</a>',
	...
	'LBL_LOGIN_PAGE' => 'Trang đăng nhập: ',
);
?>
