...
');
					<?php elseif ($this->_tpl_vars['tablestuff']['Stufftype'] == 'ReportCharts'): ?>
						loadStuff(<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
,'<?php echo $this->_tpl_vars['tablestuff']['Stufftype']; ?>
');
					<?php endif; ?>
...
if ($this->_foreach['homeframe']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['index'] => $this->_tpl_vars['tablestuff']):
        $this->_foreach['homeframe']['iteration']++;
?>
		<?php if (( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Default' || $this->_tpl_vars['tablestuff']['Stufftitle'] != getTranslatedString('Home Page Dashboard', 'Home') ) && $this->_tpl_vars['tablestuff']['Stufftype'] != 'DashBoard' && $this->_tpl_vars['tablestuff']['Stufftype'] != 'ReportCharts'): ?>
			{
...
<?php if ($this->_tpl_vars['FIRST_TIME_LOGIN']): ?>
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "Home/FirstTimeLogin.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>