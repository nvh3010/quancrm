<?php /* Smarty version 2.6.18, created on 2014-05-15 04:05:04
         compiled from ComposeEmail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ComposeEmail.tpl', 82, false),array('modifier', 'emails_checkFieldVisiblityPermission', 'ComposeEmail.tpl', 88, false),array('modifier', 'getTranslatedString', 'ComposeEmail.tpl', 126, false),array('modifier', 'vtlib_purify', 'ComposeEmail.tpl', 137, false),)), $this); ?>
...
" LANGUAGE=javascript onClick="$('parent_id').value=''; $('hidden_toid').value='';$('parent_name').value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
	...
	<tr>
	<?php if (emails_checkFieldVisiblityPermission('ccmail', 'readwrite') == '0'): ?>   
...
" style="width:99%">&nbsp;
   ...
   <?php if (emails_checkFieldVisiblityPermission('bccmail', 'readwrite') == '0'): ?>   
   	<tr>
...
_hidden" value="" />
                        <span id="limitmsg" style= "color:red; display:'';"><?php echo getTranslatedString('LBL_MAX_SIZE', $this->_tpl_vars['MODULE']); ?>
