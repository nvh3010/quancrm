<?php /* Smarty version 2.6.18, created on 2014-05-14 19:37:26
...
" id='maxrecords'>
<input id="recordid" type="hidden" value="<?php echo $this->_tpl_vars['RECORDID']; ?>
">
<input type="hidden" name="mode">
<input type="hidden" name="return_module" id="return_module" value="<?php echo $this->_tpl_vars['MODULE']; ?>
">
<input type="hidden" name="RLreturn_module" id="RLreturn_module" value="<?php echo $this->_tpl_vars['MODULE']; ?>
">
...
">
<input type="hidden" name="RLparent_id" id="RLparent_id" value="<?php echo $this->_tpl_vars['ID']; ?>
">
...
">
	<input type="hidden" name="currency_id" value="<?php echo $this->_tpl_vars['CURRENCY_ID']; ?>
">
