<?php /* Smarty version 2.6.18, created on 2014-05-14 19:36:01
         compiled from Settings/LayoutBlockList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Settings/LayoutBlockList.tpl', 403, false),)), $this); ?>
...
function getCustomFieldList(customField)
{
	...
	$('module_info').innerHTML = '<?php echo $this->_tpl_vars['MOD']['LBL_CUSTOM_FILED_IN']; ?>
 "'+modulename+'" <?php echo $this->_tpl_vars['APP']['LBL_MODULE']; ?>
';
	new Ajax.Request(
		'index.php',
...
<?php $this->assign('entries', $this->_tpl_vars['CFENTRIES']); ?>
			<?php if ($this->_tpl_vars['CFENTRIES']['0']['tabpresence'] == '0'): ?>
...
"></td>
        <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
			...
			<table class="settingsSelUITopLine" border="0" cellpadding="5" cellspacing="0" width="100%">
				<tr>
					<td rowspan="2" valign="top" width="50"><img src="<?php echo vtiger_imageurl('orgshar.gif', $this->_tpl_vars['THEME']); ?>
" alt="Users" title="Users" border="0" height="48" width="48"></td>
					<td class="heading2" valign="bottom">
						<b><a href="index.php?module=Settings&action=ModuleManager&parenttab=Settings"><?php echo $this->_tpl_vars['MOD']['VTLIB_LBL_MODULE_MANAGER']; ?>
</a> 
						&gt;<a href="index.php?module=Settings&action=ModuleManager&module_settings=true&formodule=<?php echo $this->_tpl_vars['MODULE']; ?>
&parenttab=Settings"><?php if ($this->_tpl_vars['APP'][$this->_tpl_vars['MODULE']]): ?> <?php echo $this->_tpl_vars['APP'][$this->_tpl_vars['MODULE']]; ?>
 <?php elseif ($this->_tpl_vars['MOD'][$this->_tpl_vars['MODULE']]): ?> <?php echo $this->_tpl_vars['MOD'][$this->_tpl_vars['MODULE']]; ?>
 <?php else: ?> <?php echo $this->_tpl_vars['MODULE']; ?>
 <?php endif; ?></a> &gt; 
						<?php echo $this->_tpl_vars['MOD']['LBL_LAYOUT_EDITOR']; ?>
</b>
					</td>
				</tr>
				<tr>
					<td class="small" valign="top"><?php echo $this->_tpl_vars['MOD']['LBL_LAYOUT_EDITOR_DESCRIPTION']; ?>

					</td>
					<td align="right" width="15%"><input type="button" class="crmButton create small" onclick="callRelatedList('<?php echo $this->_tpl_vars['CFENTRIES']['0']['module']; ?>
');fnvshNrm('relatedlistdiv');posLay(this,'relatedlistdiv');" alt="<?php echo $this->_tpl_vars['MOD']['ARRANGE_RELATEDLIST']; ?>
" title="<?php echo $this->_tpl_vars['MOD']['ARRANGE_RELATEDLIST']; ?>
" value="<?php echo $this->_tpl_vars['MOD']['ARRANGE_RELATEDLIST']; ?>
"/>
					</td>
					<td align="right" width="8%"><input type="button" class="crmButton create small" onclick="fnvshobj(this,'addblock');" alt="<?php echo $this->_tpl_vars['MOD']['ADD_BLOCK']; ?>
" title="<?php echo $this->_tpl_vars['MOD']['ADD_BLOCK']; ?>
" value="<?php echo $this->_tpl_vars['MOD']['ADD_BLOCK']; ?>
"/>
					</td>
					&nbsp; <img src="<?php echo vtiger_imageurl('vtbusy.gif', $this->_tpl_vars['THEME']); ?>
" id="vtbusy_info" style="display:none;position:absolute;top:180px;right:100px;" border="0" />
				</tr>
			</table>
				
			<div id="cfList">
                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "Settings/LayoutBlockEntries.tpl", 'smarty_include_vars' => array()));
...
" ></td>
		...
		<a href='javascript:window.history.back();'><?php echo $this->_tpl_vars['MOD']['LBL_GO_BACK']; ?>
</a><br>								   						     </td>
		</tr>
		</tbody></table> 
		</div>
