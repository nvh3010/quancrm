<?php /* Smarty version 2.6.18, created on 2014-05-14 11:05:34
...
<tr>
	...
	<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap><a class="hdrLink" href="index.php?action=<?php echo $this->_tpl_vars['action']; ?>
...
" border="0"></a></td>	
				<?php elseif ($this->_tpl_vars['CHECK']['Import'] == 'yes' && $this->_tpl_vars['MODULE'] == 'Calendar'): ?>
                    <td style="padding-right:10px"><a name='import_link' href="javascript:void(0);" onclick="fnvshobj(this,'CalImport');" ><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
tbarImport.gif" alt="<?php echo $this->_tpl_vars['APP']['LBL_IMPORT']; ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['MODULE'])) ? $this->_run_mod_handler('getTranslatedString', true, $_tmp, $this->_tpl_vars['MODULE']) : getTranslatedString($_tmp, $this->_tpl_vars['MODULE'])); ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_IMPORT']; ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['MODULE'])) ? $this->_run_mod_handler('getTranslatedString', true, $_tmp, $this->_tpl_vars['MODULE']) : getTranslatedString($_tmp, $this->_tpl_vars['MODULE'])); ?>
...
"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
findduplicates.gif" alt="<?php echo $this->_tpl_vars['APP']['LBL_FIND_DUPICATES']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_FIND_DUPLICATES']; ?>
" border="0"></a></td> -->
					<td style="padding-right:10px"><a href="javascript:;" onClick="moveMe('mergeDup');mergeshowhide('mergeDup');searchhide('searchAcc','advSearch');"><img src="<?php echo vtiger_imageurl('findduplicates.gif', $this->_tpl_vars['THEME']); ?>
