<?php /* Smarty version 2.6.18, created on 2014-05-14 08:22:38
         compiled from Home/HomeBlock.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'Home/HomeBlock.tpl', 67, false),array('modifier', 'vtiger_imageurl', 'Home/HomeBlock.tpl', 72, false),array('modifier', 'truncate', 'Home/HomeBlock.tpl', 127, false),array('modifier', 'is_array', 'Home/HomeBlock.tpl', 149, false),)), $this); ?>
...
<?php elseif ($this->_tpl_vars['HOME_STUFFTYPE'] == 'ReportCharts'): ?>
		<td  valign="top" align='center' class="homePageMatrixHdr" style="height:28px;" width=60%>
			<input type="radio" id="reportradio_0" name="reportradio_<?php echo $this->_tpl_vars['HOME_STUFFID']; ?>
" value="horizontalbarchart" <?php if ($this->_tpl_vars['DASHDETAILS'][$this->_tpl_vars['HOME_STUFFID']]['Chart'] == 'horizontalbarchart'): ?>checked<?php endif; ?>>Horizontal
			<input type="radio" id="reportradio_1" name="reportradio_<?php echo $this->_tpl_vars['HOME_STUFFID']; ?>
" value="verticalbarchart"<?php if ($this->_tpl_vars['DASHDETAILS'][$this->_tpl_vars['HOME_STUFFID']]['Chart'] == 'verticalbarchart'): ?>checked<?php endif; ?>>Vertical
			<input type="radio" id="reportradio_2" name="reportradio_<?php echo $this->_tpl_vars['HOME_STUFFID']; ?>
" value="piechart" <?php if ($this->_tpl_vars['DASHDETAILS'][$this->_tpl_vars['HOME_STUFFID']]['Chart'] == 'piechart'): ?>checked<?php endif; ?>>Pie
		</td>
	</tr>
	<tr>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " class="crmbutton small save" onclick="saveEditReportCharts(<?php echo $this->_tpl_vars['HOME_STUFFID']; ?>
)">
			<input type="button" name="cancel" title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" value="  <?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
<input type=hidden id="test_<?php echo $this->_tpl_vars['HOME_STUFFID']; ?>
" value = <?php echo $this->_tpl_vars['HOME_STUFFTYPE']; ?>
/>
...
<?php elseif ($this->_tpl_vars['HOME_STUFFTYPE'] == 'ReportCharts'): ?>
        <input type=hidden id=more_<?php echo $this->_tpl_vars['HOME_STUFFID']; ?>
 value="<?php echo $this->_tpl_vars['DASHDETAILS'][$this->_tpl_vars['HOME_STUFFID']]['ReportId']; ?>
"/>
	<table border=0 cellspacing=0 cellpadding=5 width=100%>
		<tr>
			<td align="left"><?php echo $this->_tpl_vars['HOME_STUFF']; ?>
