...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Home/HomeButtons.tpl', 26, false),array('modifier', 'getTranslatedString', 'Home/HomeButtons.tpl', 101, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['ALLOW_REPORT'] == 'yes'): ?>
		<li>
			<a href='javascript:;' class='drop_down' id="addReportCharts">
				<?php echo getTranslatedString('LBL_REPORTCHARTS', $this->_tpl_vars['MODULE']); ?>
...
<?php endif; ?>
        <li>
			<a href='javascript:;' class='drop_down' id="defaultwidget">
				<?php echo getTranslatedString('LBL_DEFAULT_WIDGET', $this->_tpl_vars['MODULE']); ?>
...
<font color='red'>*</font></td>
			...
			<tr id="reportTypeRow" style="display:none">
				<td class="dvtCellLabel" align="right" width="110"><?php echo getTranslatedString('LBL_HOME_REPORT_TYPE', $this->_tpl_vars['MODULE']); ?>
</td>
