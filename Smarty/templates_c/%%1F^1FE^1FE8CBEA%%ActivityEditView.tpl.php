<?php /* Smarty version 2.6.18, created on 2014-05-14 19:37:33
         compiled from ActivityEditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'ActivityEditView.tpl', 23, false),array('modifier', 'count', 'ActivityEditView.tpl', 368, false),array('modifier', 'vtiger_imageurl', 'ActivityEditView.tpl', 1000, false),)), $this); ?>
...
' class="crmButton small edit" onclick="document.EditView.del_actparent_rel.value=document.EditView.parent_id.value;document.EditView.parent_id.value='';document.EditView.parent_name.value='';">
							...
							<?php endif; ?>
			     			<?php if ($this->_tpl_vars['IS_CONTACTS_EDIT_PERMITTED'] == 'true'): ?>
							<tr>
...
" type="hidden">
									...
									<?php $_from = $this->_tpl_vars['CONTACTSNAME']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['cntid'] => $this->_tpl_vars['contactname']):
?>
                                    	<option value="<?php echo $this->_tpl_vars['cntid']; ?>
"><?php echo $this->_tpl_vars['contactname']; ?>
</option>
                                    <?php endforeach; endif; unset($_from); ?>
									</select>
...
<?php if ($this->_tpl_vars['PICKIST_DEPENDENCY_DATASOURCE'] != ''): ?>
<script type="text/javascript">
	Event.observe(window, 'load', function() { (new FieldDependencies(<?php echo $this->_tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']; ?>
)).init() });
</script>
<?php endif; ?>