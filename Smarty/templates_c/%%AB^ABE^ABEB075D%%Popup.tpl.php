<?php /* Smarty version 2.6.18, created on 2014-05-14 19:33:37
...
<script language="JavaScript" type="text/javascript" src="modules/<?php echo $this->_tpl_vars['RETURN_MODULE']; ?>
...
Ajax&ajax=true&search=true';
	...
	urlstring += "&popupmode=<?php echo $this->_tpl_vars['POPUPMODE']; ?>
";
	urlstring += "&callback=<?php echo $this->_tpl_vars['CALLBACK']; ?>
";
