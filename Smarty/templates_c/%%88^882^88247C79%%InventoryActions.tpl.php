<?php /* Smarty version 2.6.18, created on 2014-05-14 19:34:52
         compiled from Inventory/InventoryActions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Inventory/InventoryActions.tpl', 37, false),array('modifier', 'getTranslatedString', 'Inventory/InventoryActions.tpl', 158, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['MODULE'] != 'Products' && $this->_tpl_vars['MODULE'] != 'Services' && $this->_tpl_vars['MODULE'] != 'Vendors' && $this->_tpl_vars['MODULE'] != 'PriceBooks'): ?>
...
'; ?>
	...
	<?php if ($this->_tpl_vars['MODULE'] == 'Invoice'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['INV_NO']; ?>
','Invoice');
	<?php elseif ($this->_tpl_vars['MODULE'] == 'Quotes'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['QUO_NO']; ?>
','Quote');
	<?php elseif ($this->_tpl_vars['MODULE'] == 'PurchaseOrder'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['PO_NO']; ?>
','PurchaseOrder');
	<?php elseif ($this->_tpl_vars['MODULE'] == 'SalesOrder'): ?>
		OpenCompose('<?php echo $this->_tpl_vars['SO_NO']; ?>
','SalesOrder');
	<?php endif; ?>
<?php echo '
}
