<?php /* Smarty version 2.6.18, created on 2014-05-14 19:36:02
         compiled from Settings/LayoutBlockEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Settings/LayoutBlockEntries.tpl', 24, false),array('modifier', 'getTranslatedString', 'Settings/LayoutBlockEntries.tpl', 71, false),array('modifier', 'cat', 'Settings/LayoutBlockEntries.tpl', 384, false),array('modifier', 'count', 'Settings/LayoutBlockEntries.tpl', 413, false),)), $this); ?>
...
"><?php echo getTranslatedString($this->_tpl_vars['value']['fieldlabel'], $this->_tpl_vars['MODULE']); ?>
</option>
...
"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url(<?php echo vtiger_imageurl('skype.gif', $this->_tpl_vars['THEME']); ?>
                                                                                                ...
                                                                                                <tr><td align="left"><a id="field13_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url(<?php echo vtiger_imageurl('time.PNG', $this->_tpl_vars['THEME']); ?>
);" 		onclick = "makeFieldSelected(this,13,<?php echo $this->_tpl_vars['entries']['blockid']; ?>
);"> <?php echo $this->_tpl_vars['MOD']['Time']; ?>
 </a></td></tr>
																							</table>
																						</div>	
																					</td>
...
"  type="checkbox" 
												...
												<tr>
													<td valign="top" class="dvtCellInfo" align="left" width="10px">
														<?php $this->assign('defaultsetting', $this->_tpl_vars['value']['defaultvalue']); ?>
														<input id="defaultvalue_check_<?php echo $this->_tpl_vars['value']['fieldselect']; ?>
"  type="checkbox" 
														<?php if ($this->_tpl_vars['defaultsetting']['permitted'] == false): ?>
															disabled 
														<?php endif; ?>
														<?php if ($this->_tpl_vars['defaultsetting']['value'] != ''): ?>
															checked
														<?php endif; ?>
													</td>
													<td valign="top" class="dvtCellInfo" align="left">	
														&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_DEFAULT_VALUE']; ?>
<br>
														<?php $this->assign('fieldElementId', ((is_array($_tmp='defaultvalue_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['value']['fieldselect']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['value']['fieldselect']))); ?>
														<?php if ($this->_tpl_vars['defaultsetting']['permitted'] == true): ?>
                											<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "Settings/FieldUI.tpl", 'smarty_include_vars' => array('_FIELD_UI_TYPE' => $this->_tpl_vars['value']['uitype'],'_FIELD_SELECTED_VALUE' => $this->_tpl_vars['defaultsetting']['value'],'_FIELD_ELEMENT_ID' => $this->_tpl_vars['fieldElementId'],'_ALL_AVAILABLE_VALUES' => $this->_tpl_vars['defaultsetting']['_allvalues'])));
...
','<?php echo $this->_tpl_vars['MODULE']; ?>
','updateFieldProperties','<?php echo $this->_tpl_vars['value']['typeofdata']; ?>
');" />&nbsp;
