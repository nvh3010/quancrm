<?php /* Smarty version 2.6.18, created on 2014-05-14 19:36:13
         compiled from salesEditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtlib_purify', 'salesEditView.tpl', 43, false),array('modifier', 'vtiger_imageurl', 'salesEditView.tpl', 76, false),array('modifier', 'getTranslatedString', 'salesEditView.tpl', 88, false),array('modifier', 'cat', 'salesEditView.tpl', 93, false),)), $this); ?>
...
'" type="submit" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:70px" >
                                                                                                <?php elseif ($this->_tpl_vars['MODULE'] == 'Accounts'): ?><?php if ($this->_tpl_vars['MODE'] == 'edit'): ?>
											<input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
