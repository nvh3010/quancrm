...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'implode', 'Settings/ModuleManager/ModuleManagerAjax.tpl', 17, false),array('modifier', 'vtiger_imageurl', 'Settings/ModuleManager/ModuleManagerAjax.tpl', 59, false),array('modifier', 'getTranslatedString', 'Settings/ModuleManager/ModuleManagerAjax.tpl', 136, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['modinfo']['customized'] == false): ?>
	...
	<tr>
		...
		<td class="cellLabel small" colspan=2><?php echo getTranslatedString($this->_tpl_vars['modulelabel'], $this->_tpl_vars['MODULE']); ?>
</td>
		<td class="cellText small" width="15px" align=center>
			<?php if ($this->_tpl_vars['modinfo']['presence'] == 0): ?>
				<a href="javascript:void(0);" onclick="vtlib_toggleModule('<?php echo $this->_tpl_vars['modulename']; ?>
