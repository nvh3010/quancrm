...
for($i=0; $i<10; $i++) {
	...
	if($i>4) {
		...
		$qty_in_stock	=	rand(10000, 99999);
		$category 	= 	"Software";
		$website 	=	"www.Quansolid@blogspot.com";
		$manufacturer	= 	"Võ Trần Quân.";
...
$portalname = array ("Võ Trần Quân", "Võ Trần Quân Blogs", "Võ Trần Quân Facebook", "Võ Trần Quân Google +", "|");
$portalurl = array ("#", "http://quansolid@blogspot.com", "https://www.facebook.com/qz.vo1", "https://plus.google.com/u/0/", "#");
