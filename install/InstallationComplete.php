				...
				<div style="width:100%;padding:10px;" align=left>
					...
					<ul>
						...
						<li><?php echo $installationStrings['LBL_TUTORIAL_TEXT']; ?>
							<a href="http://youtube.com/quansolid" target="_blank">http://youtube.com/quansolid</a>
						</li>
					</ul>
					<br>
					...
					<ul><b>
						...
						<li><?php echo $installationStrings['LBL_DROP_A_MAIL']; ?>
							<a href="mailto:vtquan243@gmail.com" target="_blank">vtquan243@gmail.com</a>
						</li>
					</b></ul>
					<ul>
...
<table border=0 cellspacing=0 cellpadding=0 width=80% align=center>
	<tr>
		<td class=small align=center> <a href="#" target="_blank">Võ Trần Quân</a></td> | <?php echo $statimage ?>
	</tr>
</table>
</body>
</html>	